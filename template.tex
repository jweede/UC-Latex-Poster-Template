...
% Modified for UC by TJ Ellis April 2011
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\setbeamercolor{block title}{fg=UCRed,bg=white}
\setbeamercolor{block body}{fg=UCBlack,bg=white}
\setbeamercolor{block alerted title}{fg=white,bg=UCRed}
  ...
  \begin{columns}[t]												% the [t] option aligns the column's content at the top
    ...
    \begin{column}{\threecolwid}					  % create a three-column-wide column and then we will split it up later
      ...
      \begin{columns}[t,totalwidth=\threecolwid]	% split up that three-column-wide column
        ...
        \end{column}
        \begin{column}{\onecolwid}
          \setbeamercolor{block alerted title}{fg=white,bg=UCBlack}	% frame color
          \setbeamercolor{block alerted body}{fg=UCBlack,bg=white}		% body color
          \begin{alertblock}{Alert Block Colours}
            You can similarly modify the colours for alert blocks (but try not to overdo it):\\
            \begin{semiverbatim}
              {\color{red}\\setbeamercolor}\{block title\}\newline \{fg=black,bg=UCBlack\}
            \end{semiverbatim}
            \begin{semiverbatim}
              {\color{red}\\setbeamercolor}\{block  body\}\newline \{fg=UCBlack,bg=white\}
            \end{semiverbatim}
          \end{alertblock}        
        \end{column}
        \begin{column}{\onecolwid}
          \begin{block}{References}
            Some references and a graphic to show you how it's done:
		        ...
		        \end{thebibliography}}
			      \vspace{0.75in}
			      \begin{center}
			        \includegraphics[width=5in]{UC_logo.pdf}
			      \end{center}
		      \end{block}
        \end{column}
      \end{columns}
